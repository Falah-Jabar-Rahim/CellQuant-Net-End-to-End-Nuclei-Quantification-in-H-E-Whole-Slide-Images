...
if IGEMM_DIR not in sys.path:
    sys.path.insert(0, IGEMM_DIR)

try:
    import depthwise_conv2d_implicit_gemm
    print(f"Using iGEMM from: {depthwise_conv2d_implicit_gemm.__file__}")
except Exception as e:
    print(f"Failed to load iGEMM: {e}")
    depthwise_conv2d_implicit_gemm = None
